# hungphucode Project Memory

This directory contains structured memories specific to the hungphucode project.
...
.claude/memory/
  ...
  bugs-and-lessons/
    README.md            ← Bugs fixed and lessons learned
  decisions/
    README.md            ← Key tech and architecture decisions
  architecture/
    README.md            ← System structure and module boundaries
```
...
| Folder | Read when... |
|--------|-------------|
| `bugs-and-lessons/` | Fixing a bug, debugging, or working in an area that had past issues |
| `decisions/` | Making a significant technical choice, or understanding why something was built a certain way |
| `architecture/` | Refactoring, adding new modules, or understanding system boundaries |
