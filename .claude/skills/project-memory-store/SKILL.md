...
| File | What to store |
|------|--------------|
| `bugs-and-lessons/README.md` | Bugs fixed, debugging insights, surprising behaviors |
| `decisions/README.md` | Tech choices, architecture decisions with rationale |
| `architecture/README.md` | Module changes, new patterns, system structure updates |
